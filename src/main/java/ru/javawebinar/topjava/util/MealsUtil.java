...
public class MealsUtil {
    ...
    private static final List<MealTo> mealTos = getTos(meals,DEFAULT_CALORIES_PER_DAY);
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static MealTo getMealTo(int id){
        return mealTos.stream().filter(f -> f.getId() == id).findFirst().get();
    }
}
