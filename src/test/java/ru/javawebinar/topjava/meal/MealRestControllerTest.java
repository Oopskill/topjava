...
public class MealRestControllerTest extends AbstractControllerTest {
    ...
    void getAll() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(MEAL_TO_MATCHER.contentJson(getMealsTo()));
    }
    ...
    void createWithLocation() throws Exception {
        ...
        MEAL_MATCHER.assertMatch(created, mealService.get(newId, SecurityUtil.authUserId()));
    }
    ...
    void update() throws Exception {
        ...
        MEAL_MATCHER.assertMatch(updMeal, mealService.get(MEAL1_ID, SecurityUtil.authUserId()));
    }
